$(function(){
	...
	var musicImgsData = ['img/bg1.jpg','img/bg2.jpg','img/bg3.jpg','img/bg4.jpg','img/bg5.jpg','img/bg6.jpg','img/bg7.jpg','img/bg8.jpg','img/bg9.jpg'];    // 图片地址数组
    var musicNameData = ['出山','盗将行','归去来兮','The New King','你从未离去','Fatal Love','第一个清晨','在你身边就失去超能力','平凡之路'];                   // 歌曲名数组
    var artistNameData = ['花粥/王胜娚','花粥/马雨阳','花粥','Vicetone','白挺','Strictlyviolin荀博','yihuik苡慧','神羊esh','纯英语'];            // 创作歌手数组
    var musicUrls=['mp3/music1.mp3','mp3/music2.mp3','mp3/music3.mp3','mp3/music4.mp3','mp3/music5.mp3','mp3/music6.mp3','mp3/music7.mp3','mp3/music8.mp3','mp3/music9.mp3'];// 歌曲mp3数组
